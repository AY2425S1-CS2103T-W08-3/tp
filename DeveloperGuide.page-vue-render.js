...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EduManage")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tuition teacher")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tuition teacher requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to delete a specific student in the list.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage deletes the student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add notes to a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tuition teacher requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to update the notes of a specific student in the list.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage updates the notes details the student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given name is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add and view tasks for a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tuition teacher requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to add a task to a specific student in the list.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage updates the student’s outstanding tasks list.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to view list of tasks of the student.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage displays the student’s outstanding tasks list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given student is invalid/cannot be found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Wrong format for deadline was given.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. No task description was given.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("5a. The given student is invalid/cannot be found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add subjects for a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tuition teacher requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to tag a specific student in the list according to his/her school level and/or subject.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage updates the corresponding subjects of the student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given student is invalid/cannot be found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Multiple school level subjects were given.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. No subjects were given.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View specific student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Tuition teacher requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows a list of students.")])]),_v(" "),_c('li',[_c('p',[_v("Tuition teacher requests to view a specific student.")])]),_v(" "),_c('li',[_c('p',[_v("EduManage shows the details from the student.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given student is invalid/cannot be found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. EduManage shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Emergency contact")]),_v(": The contact to use if an emergency happens during the tutoring period")]),_v(" "),_c('li',[_c('strong',[_v("School level")]),_v(": The level of study a student is currently at, eg. Secondary 3 ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("S3")]),_v(") or Junior College 1 ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JC1")]),_v(")")]),_v(" "),_c('li',[_c('strong',[_v("Subject")]),_v(": The subject the student is receiving tuition for, eg. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Math")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("English")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Literature")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Wed, 23 Oct 2024, 20:45:47 GMT+8]")])])])}
}];
